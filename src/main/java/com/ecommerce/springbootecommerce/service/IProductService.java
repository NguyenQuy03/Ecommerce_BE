...
public interface IProductService {
    ...
    BaseDTO<ProductDTO> findAllByAccountIdAndProductStatusAndProductItemStatus(long accountId, ProductStatus productStatus, ProductStatus productItemStatus, int page, int size);
