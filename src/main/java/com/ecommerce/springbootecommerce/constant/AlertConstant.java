...
public class AlertConstant {
    ...
    public static final String ALERT_WRONG_CONFIRM_PASSWORD = "Password must match";
    public static final String ALERT_USERNAME_EXISTED = "The user name has existed, please choose another.";
