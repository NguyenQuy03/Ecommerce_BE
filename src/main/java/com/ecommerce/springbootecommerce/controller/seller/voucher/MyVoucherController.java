package com.ecommerce.springbootecommerce.controller.seller.voucher;
...
import com.ecommerce.springbootecommerce.service.impl.VoucherService;

@Controller(value = "myVoucherControllerOfSeller")
@RequestMapping("/seller/voucher/list")
public class MyVoucherController {

    private IVoucherService voucherService;

    public MyVoucherController(VoucherService voucherService) {
    ...
    public String displayOnGoing(
        ...
        BaseDTO<VoucherDTO> dto = voucherService.findAllByAccountIdAndStatus(userDetails.getId(), VoucherStatus.ONGOING,
                page - 1, size);
    ...
    public String displayUpComing(
        ...
        BaseDTO<VoucherDTO> dto = voucherService.findAllByAccountIdAndStatus(userDetails.getId(),
                VoucherStatus.UPCOMING, page - 1, size);
    ...
    public String displayExpired(
        ...
        BaseDTO<VoucherDTO> dto = voucherService.findAllByAccountIdAndStatus(userDetails.getId(), VoucherStatus.EXPIRED,
                page - 1, size);
    ...
    private String generic(Model model, BaseDTO<VoucherDTO> dto, String tab) {
        ...
        return "seller/voucher/myVoucher";
    }
}
