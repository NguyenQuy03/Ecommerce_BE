...
public class ProductController {
    ...
    public String displayProduct(
        ...
        if (!dto.getStatus().equals(ProductStatus.ACTIVE)) {
        ...
        //     OrderDTO orderDTO = orderService.findOneByCartIdAndAccountIdAndStatus(cartDTO.getId(),
        //             dto.getAccount().getId(), OrderStatus.PENDING);
        ...
        //             OrderItemDTO orderItemDTO = orderItemService.findOneByOrderIdAndProductItemId(orderDTO.getId(),
        //                     dto.getProductItems().get(i).getId());
        ...
        //     model.addAttribute(RedisConstant.REDIS_USER_INFO_QUANTITY_ORDER,
        //             redisUtil.getHashField(RedisConstant.REDIS_USER_INFO + userDetails.getUsername(),
        //                     RedisConstant.REDIS_USER_INFO_QUANTITY_ORDER));
        // }

        BaseDTO<ProductDTO> suggestProducts = productService.findAllByAccountIdAndStatus(dto.getAccount().getId(),
                ProductStatus.ACTIVE, 1, 10);
