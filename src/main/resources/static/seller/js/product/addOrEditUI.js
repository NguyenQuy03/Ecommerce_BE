...
function addSpecRow(){
    newSpecRow =
        '<div class="spec-el spec-row d-flex fit-spec-content row">' +
            '<label for="specification" class="col-sm-2 col-form-label"></label>' +
            '<div class="col-sm-4"><input required type="text" maxlength="18" class="form-control" class="spec-key input-group-text"></div>' +
            '<div class="col-sm-4"><input required type="text" maxlength="24" class="form-control" class="spec-value form-control"></div>' +
            '<div class="col-sm-2">' +
